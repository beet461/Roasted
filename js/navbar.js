...
function create() {
    item(
        generateDiv,
        'nav-element end-divs',
        generateButton,
        'generate-button',
        'GENERATE',
        function () {
            window.location.href = href('generate/index.html');
        }
    );

    logoImage.src = href('assets/images/logo_transparent.gif');
    item(logoDiv, 'nav-element logo', logoImage, '', '', function () {
    ...
    item(
        ...
        'ABOUT',
        function () {
            window.location.href = href('about/index.html');
        }
    );
